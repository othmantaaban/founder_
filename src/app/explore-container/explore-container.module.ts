...
@NgModule({
  ...
  declarations: [ExploreContainerComponent,DonutChartComponent,CardsFinanceComponent,ListingFinanceComponent,PieChartComponent,ListingAdministrationComponent],
